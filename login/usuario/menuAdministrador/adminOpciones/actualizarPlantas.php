  ...
  if (!isset($_POST["Actualizar1"])) {
    ...
    <form method='POST' name='validarActualizar' class='form-vertical pt-5 mx-3' action='plantasActConExito.php'
      ...
      while ($fila = $paquete->fetch_array()) {
        ...
        <input type='text' class='form-control mt-1' name='nombrePlanta' value='<?php echo $fila['nombrePlanta']; ?>'>
        <br>
        <label class='col-sm-2 control-label  my-1'>Código</label>
        <input type='number' class='form-control mt-1' name='codigoPlanta' value='<?php echo $fila['codigoPlanta']; ?>'>
        <br>
