    ...
    <div class="col-12">
      ...
      if (!isset($_POST["Actualizar"])) {
        ...
        <form method='POST' class='form-horizontal mx-3' action='actualizarPlantas.php' enctype='multipart/form-data'
          autocomplete='off'>
          <tr>
            <td> <input type='hidden' class='form-control' name='idplanta' value=" . $I . "> </td>
            <label class='col-sm-2 control-label'>Nombre</label>
            <td><input type='text' class='form-control' name='nombrePlanta'></td>
            <label class='col-sm-2 control-label'>Código</label>
            <td><input type='text' class='form-control' name='codigoPlanta'></td>
            <label class='col-sm-2 control-label'>Cantidad</label>
            <td><input type='text' class='form-control' name='numeroEjemplares'></td>
            <label class='col-sm-2 control-label'>Tipo</label>
            <td><input type='text' class='form-control' name='TipoPlanta'></td>
            <input type="file" class="form-control" id="archivo" name="archivo" accept="image/*">
            <td> <input type='submit' class='btn btn-success' name='Actualizar' value='Actualizar'></td>
          </tr>
        </form>
        </tbody>
        </table>
