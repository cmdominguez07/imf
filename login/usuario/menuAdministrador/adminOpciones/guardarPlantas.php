...
{ 
   ...
   <div class="navbar-mx-5 VolverDerecha">
    ...
    <form class="form-horizontal mx-3" method="post" action="guardarPlantas.php" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" minlength="2" maxlength="4"  class="form-control" id="codigoPlanta" name="codigoPlanta" required>
                <p>Máximo de 9999</p>
            </div>
    </div>
    ...
    <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number" minlength="1" maxlength="3" class="form-control" id="numeroEjemplares" name="numeroEjemplares" required>
    ...
    <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="tipoPlanta" name="tipoPlanta" pattern="Interior|Exterior|Medicinal" required>
