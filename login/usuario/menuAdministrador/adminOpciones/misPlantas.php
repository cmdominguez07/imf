...
<div class="d-flex align-items-center">
   ...
   <input type="submit" class='btn btn-success botonI mt-4'name="submit" value=" planta" onclick=location.href="/TFG/proyectoGreen/login/usuario/menuAdministrador/adminOpciones/borrarPlantas.php">
 </div>
</div>
</div>
