...
<div class="container contenido1 pt-5 w-50">
  ...
  while ($fila = $paquete->fetch_array()) {
    ?>
    <form method='POST' class='form-horizontal mx-3' action='actualizarDatosCliente.php' enctype='multipart/form-data'
      ...
      <tr>
        ...
        <td><input type='text' class='form-control' name='apellidoAct' value='<?php echo $fila['apellidoCliente']; ?>'>
        </td>
