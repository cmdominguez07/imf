...
if (!isset($_POST['submit'])) {
  ...
  <form method="post" class="d-flex justify-content-center align-items-center" action="buscadorPlantaMedicinal.php">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            while ($fila = $paquete->fetch_array()) {
              ...
              <form method='POST' action='reservaPlantaMedicinal.php'>
                <tr>
