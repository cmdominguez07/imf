  ...
  <img src="./img/1logoV.png" class="px-2" style="width:150px"></td>
    ...
    <div class="collapse navbar-collapse d-flex" id="navbarColor01">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
        <a class="nav-link mx-5" href="/TFG/proyectoGreen/login/usuario/menuCliente/clienteOpciones/devolucionPlantas.php">Carrito</a>
        </li>
        <li class="nav-item">
        <a class="nav-link mx-5" href="/TFG/proyectoGreen/login/usuario/menuCliente/clienteOpciones/actualizarDatosCliente.php">Modificar datos</a>
        </li>
        <li class="nav-item mx-5">
        <input type="submit" class="btn btn-danger" name="cantidad" value="Eliminar cuenta" onclick=location.href="//localhost/TFG/proyectoGreen/login/usuario/menuCliente/clienteOpciones/borrarCliente.php">
        </li>
</ul>
    </div>
